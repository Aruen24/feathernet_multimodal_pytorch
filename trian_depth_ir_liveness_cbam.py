...
parser.add_argument('-Save_model', type=str, help='model save path.',default='./multimodal_depth_ir_cbam_training_record/model')
parser.add_argument('-Save_tensorboard', type=str, help='tensorboard save path.',default='./multimodal_depth_ir_cbam_training_record/log')
...
parser.add_argument('-train_face', type=str, help='data for training',
                    default='/home/data03_disk/YZhang/HSLX1Datas/multiModalDatas/multiModalCrop1206')
"""""""""""""test data"""""""""""""
parser.add_argument('-test_face', type=str, help='data for testing',
                    default='/home/data03_disk/YZhang/HSLX1Datas/multiModalDatas/multiModalFaces/test')
...
def main():
    ...
    net = FeatherNet_m.FeatherNet(num_class=args.class_num, input_size=args.img_size, input_channels=args.input_channels,se=True, avgdown=True)
    net = net.to(device)
