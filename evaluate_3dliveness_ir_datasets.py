...
def eval_datasets(args):
    ...
    img_test = dataset.get_ir_liveness_data(args.test_data, 'test', True)
    img_test1 = dataset.get_ir_liveness_data_imgpath(args.test_data, 'test', True)
    ...
    for i, data in enumerate(test_loader):
        ...
        ir_img_path, label1 = img_test1[i]
...
def parse_arguments():
    ...
    parser.add_argument('-Save_model', type=str, help='model save path.',
                        default='./2d_3d_ir_training_record_0705/model')
    parser.add_argument('-Save_tensorboard', type=str, help='tensorboard save path.',
                        default='./2d_3d_ir_training_record_0705/log')
    ...
    parser.add_argument('-model_path', type=str, help='load the model path',
                        default='/home/disk01/wyw/feathernet_multimodal_pytorch/2d_3d_ir_training_record_0705/model/0705_1231/Feathernet_96.pkl')
    # set the img data
    '''test data'''
    #parser.add_argument('-test_data', type=str, help='data for testing', default='/home/disk04/wyw_data/multi_mode_live_data/casia_surf_val/fake')
    #parser.add_argument('-test_data', type=str, help='data for testing', default='/home/disk01/wyw/pytorchFeathernet/test_data/irData_1026_real0328')
    #parser.add_argument('-test_data', type=str, help='data for testing', default='/home/disk01/wyw/pytorchFeathernet/test_data/test_real0328')
    ...
    #parser.add_argument('-test_data', type=str, help='data for testing', default='/home/disk01/wyw/NIR_face_dataset/save_real_jpg_test')
    #parser.add_argument('-test_data', type=str, help='data for testing', default='/home/disk01/wyw/NIR-VIS/SAVE_NIR_real_test') 
    parser.add_argument('-test_data', type=str, help='data for testing', default='./0428_new_test/fake')
    #parser.add_argument('-test_data', type=str, help='data for testing', default='./test/fake')
