...
#parser.add_argument('-Save_model', type=str, help='model save path.',default='./multimodal_rgb_ir_training_record_0801_data_txtfile/model')
#parser.add_argument('-Save_tensorboard', type=str, help='tensorboard save path.',default='./multimodal_rgb_ir_training_record_0801_data_txtfile/log')
parser.add_argument('-Save_model', type=str, help='model save path.',default='./multimodal_rgb_ir_training_record_0428/model')
parser.add_argument('-Save_tensorboard', type=str, help='tensorboard save path.',default='./multimodal_rgb_ir_training_record_0428/log')
...
parser.add_argument('-learn_rate', type=float, help='learn rate', default=0.01)
...
parser.add_argument('-input_channels', type=int, help='the input channels', default=4)
parser.add_argument('-retrain', type=bool, help='whether to fine-turn the model', default=False)
#parser.add_argument('-resume_model', type=str, help='load the model path',default='/home/data03_disk/YZhang/multimodal_training_record/model/1215_0955/Feathernet_91.pkl')
...
#                    default='/home/data03_disk/wyw_data/multi_mode_live_data/casia_surf_train')
#parser.add_argument('-train_face', type=str, help='data for training',
#                    default='/home/disk04/wyw_data/multi_mode_live_data/casia_surf_test')

parser.add_argument('-train_face', type=str, help='data for training',
                    default='/home/disk04/wyw_data/multi_mode_live_data/0428_new_train')
#load txt path
#parser.add_argument('-train_face', type=str, help='data for training',
#                    default='/home/disk04/wyw_data/multi_mode_live_data/0428_new_train.txt')
"""""""""""""test data"""""""""""""
#parser.add_argument('-test_face', type=str, help='data for testing',
#                    default='/home/data03_disk/wyw_data/multi_mode_live_data/casia_surf_test')
#parser.add_argument('-test_face', type=str, help='data for testing',
#                    default='/home/disk04/wyw_data/multi_mode_live_data/casia_surf_train')

parser.add_argument('-test_face', type=str, help='data for testing',
                    default='/home/disk04/wyw_data/multi_mode_live_data/0428_new_test')
#load txt path                    
#parser.add_argument('-test_face', type=str, help='data for testing',
#                    default='/home/disk04/wyw_data/multi_mode_live_data/0428_new_test.txt')
...
def main():
    ...
    #net= FeatherNet.FeatherNet(num_class=args.class_num, input_size=args.img_size, input_channels=args.input_channels, se=True, avgdown=False)
    ...
    #load fold path    rgb+depth+ir
    # img_train = dataset.get_multimodal_liveness_data(args.train_face, 'train',True)
    # img_test = dataset.get_multimodal_liveness_data(args.test_face, 'test',True)
    #load fold path  rgb+ir   /home/disk04/wyw_data/multi_mode_live_data/0428_new_train
    img_train = dataset.get_rgb_ir_liveness_data(args.train_face, 'train', True)
    img_test = dataset.get_rgb_ir_liveness_data(args.test_face, 'test', True)
    #load txt file path  rgb+ir   /home/disk04/wyw_data/multi_mode_live_data/0428_new_train.txt
    #img_train = dataset.get_rgb_ir_liveness_data_from_txt(args.train_face, 'train', True, '/home/disk04/wyw_data/multi_mode_live_data/')
    #img_test = dataset.get_rgb_ir_liveness_data_from_txt(args.test_face, 'test', True, '/home/disk04/wyw_data/multi_mode_live_data/')
