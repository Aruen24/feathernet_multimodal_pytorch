...
parser.add_argument('-Save_model', type=str, help='model save path.',default='./multimodal_cbam_training_record/model')
parser.add_argument('-Save_tensorboard', type=str, help='tensorboard save path.',default='./multimodal_cbam_training_record/log')
