...
def eval_datasets(args):
    global device
    save_path = '/home/disk04/wyw_data/multi_mode_live_data/false_class_img'
    ...
    img_test = dataset.get_rgb_ir_liveness_data_from_txt(args.test_data, 'test', True, '/home/disk04/wyw_data/multi_mode_live_data/')  
    img_test1 = dataset.get_rgb_ir_liveness_data_imgpath_from_txt(args.test_data, 'test', True, '/home/disk04/wyw_data/multi_mode_live_data/')
    ...
    test_loader = DataLoader(img_test, batch_size=128, num_workers=4, shuffle=False, drop_last=False)
    ...
    for i, data in enumerate(test_loader):
        ...
        total_labels.extend(label)
        if preds_index[0] != int(label1):
            print("***************************************************************************")
            print('preds_index is %d' %(preds_index[0]))
            print('label1 is %d' %(int(label1)))
            print(ir_img_path)
            print(rgb_img_path)
...
def parse_arguments():
    ...
    parser.add_argument('-Save_model', type=str, help='model save path.',
                        default='/home/disk01/wyw/feathernet_multimodal_pytorch/multimodal_rgb_ir_training_record_0424/model')
    parser.add_argument('-Save_tensorboard', type=str, help='tensorboard save path.',
                        default='/home/disk01/wyw/feathernet_multimodal_pytorch/multimodal_rgb_ir_training_record_0424/log')
    ...
    parser.add_argument('-model_path', type=str, help='load the model path',
                        default='/home/disk01/wyw/feathernet_multimodal_pytorch/multimodal_rgb_ir_training_record_0428/model/0802_1542/Feathernet_159.pkl')
    #parser.add_argument('-model_path', type=str, help='load the model path',
    #                    default='/home/disk01/wyw/feathernet_multimodal_pytorch/multimodal_rgb_ir_training_record_0801_data_txtfile/model/0801_1735/Feathernet_160.pkl')
    # set the img data
    '''test data'''
    #parser.add_argument('-test_data', type=str, help='data for testing',
    #                    default='/home/disk04/wyw_data/multi_mode_live_data/casia_surf_val/fake')
    #parser.add_argument('-test_data', type=str, help='data for testing',
